...
uint256 hashGenesisBlock("0x76de6dbcb9347d939f10d436abfda911369035a1b1c854d879c505045e68e76e");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Bestcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Bestcoin Signed Message:\n";
...
{
    // Bestcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Bestcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Bestcoin: 3.5 days
static const int64 nTargetSpacing = 150; // Bestcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Bestcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Bestcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Bestcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe9f2f9597015ea2af22b15ad539801681ad37b47a009c6f1572d5172acae01e1");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("8fca640deebf35be206d7afcf77f1fd3111fb1c5055eb78dae680dce45098b5095767870181ec853e6a2989517396045d92c2c28df9c1f936bdbaa78b9e11c1c03") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1554992884;
        block.nBits    = 504365644;
        block.nNonce   = 53605651;

        if (fTestNet)
        {
            block.nTime    = 1554992884;
            block.nNonce   = 2320522380;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb4228d670f8cebbd29d48412e34bbfa82ce65ed562aabc9d2ed9ad58aecf0154"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Bestcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BestcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BestcoinMiner : ProcessBlock, block not accepted");
    }
